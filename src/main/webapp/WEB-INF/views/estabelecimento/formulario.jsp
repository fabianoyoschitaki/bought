	...
	<div class="container">
		...
		<form action="adicionaEstabelecimento" method="post" class="form-horizontal" role="form">
			<div class="form-group">
				<label class="control-label col-sm-2" for="codigoEstabelecimento">Código do Estabelecimento:</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="codigoEstabelecimento" id="codigoEstabelecimento"
